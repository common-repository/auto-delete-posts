...
== Installation ==
= First time =
1. Go to 'Settings->Auto Delete Posts' to view the current configuration.
2. Modify options, enable plugin and UPDATE.

You're done.
= Upgrade (pre v1.2) =
1. Update the plugin, activate, deactivate and re-activate the plugin to remove configuration from previous versions.
